...
//	    }
   ...
   public void setOnCheckedChangeWidgetListener(OnCheckedChangeListener listener) {
    ...
    /**
     * Interface definition for a callback to be invoked when the checked state of a checkable button changed.
     */
